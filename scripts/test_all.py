...
SCENARIOS = [
    ("play espresso by sabrina carpenter", ["spencer", "chris"], "spotify_play"),
    ("play the song WAP by cardi b",        ["marta", "chris"],   "spotify_play"),
    ("reschedule my dentist appointment to Friday", ["spencer", "julie"], "write_schedule"),
    ("what's on my calendar today",         ["chris"],             "read_schedule"),
    ("what's the weather today",            ["guest", "marta"],    "weather"),
    ("add soccer practice to the calendar for Saturday 10am", ["julie"], "write_schedule"),
